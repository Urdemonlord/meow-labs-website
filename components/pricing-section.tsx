...
export function PricingSection() {
  ...
  const packages = [
    ...
    {
      name: "Paket Wedding Digital",
      originalPrice: "3.000.000",
      price: "2.200.000",
      renewalPrice: "900.000",
      discount: "27%",
      description: "Undangan pernikahan digital elegan dengan fitur RSVP dan galeri momen",
      features: [
        "Desain tema wedding premium",
        "Undangan multi bahasa",
        "RSVP & konfirmasi hadir",
        "Galeri foto & video love story",
        "Countdown acara & peta lokasi",
        "Integrasi Google Maps & navigasi",
        "Quotes romantis custom",
        "Musik latar pilihan pasangan",
      ],
      popular: true,
      color: "primary",
      whatsappMessage: "Hallo admin saya ingin konsultasi untuk paket wedding digital",
    },
    {
      name: "Paket Love Celebration",
      originalPrice: "1.500.000",
      price: "1.050.000",
      renewalPrice: "600.000",
      discount: "30%",
      description: "Website ucapan ulang tahun romantis untuk pasangan tersayang",
      features: [
        "Halaman love letter interaktif",
        "Timeline kenangan berdua",
        "Galeri foto & video",
        "Pesan suara atau video surprise",
        "Mini game kuis pasangan",
        "Fitur kirim doa & ucapan teman",
        "Share link ke sosial media",
        "Support update konten 1 bulan",
      ],
      popular: false,
      color: "secondary",
      whatsappMessage: "Hallo admin saya ingin tanya paket website ucapan ulang tahun romantis",
    },
  ]
